...
export class NeuralNet {
  ...
  static fromJSON(json: SerializedNet | LegacySerializedNet): NeuralNet {
...
/** The pre-base64 shape. Only ever read, never written. */
export interface LegacySerializedNet {
  topology: NNTopology;
  w1: number[];
  b1: number[];
  w2: number[];
...
function encodeWeights(arr: Float32Array): string {
...
function decodeWeights(value: string | number[]): Float32Array {
