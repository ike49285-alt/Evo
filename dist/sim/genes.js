...
function decodeOrganelleKind(unit) {
...
export function decodeOrganelleGene(gene) {
...
export function decodeOrganelles(seq) {
...
export function mutateGeneSequence(parent, rng) {
    ...
    if (organelleGenes.length > TRAIT_LIMITS.maxOrganelles)
        organelleGenes = organelleGenes.slice(0, TRAIT_LIMITS.maxOrganelles);
...
function organelleKindHistogram(seq) {
    const hist = {};
