...
import { buildGenome, buildOrganelles, deriveArmorMitigation, deriveFlagellaPower, deriveMaxSpeed, deriveMouthPower, encodeGeneSequence, genomeFromSequence, hasBud, } from './genome.js';
...
export class World {
    ...
    seedBaseSpecies() {
        ...
        }, 16, { name: 'Dandelions', spread: true });
